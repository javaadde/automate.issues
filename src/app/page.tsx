...
export default function Home() {
  return (
    <div className="bg-background-light dark:bg-background-dark font-sans text-[#101019] selection:bg-primary selection:text-white min-h-screen">
      {/* Top Navigation */}
      <header className="fixed top-0 left-0 right-0 z-50 px-6 py-4">
        <nav className="max-w-7xl mx-auto flex items-center justify-between px-6 py-3 bg-white/80 dark:bg-background-dark/80 backdrop-blur-xl rounded-full border border-gray-200 dark:border-white/10 shadow-sm transition-all duration-300">
          <div className="flex items-center gap-2">
            <div className="bg-primary p-1.5 rounded-lg">
              <span className="material-symbols-outlined text-white text-xl">rocket_launch</span>
            </div>
            <span className="text-xl font-bold tracking-tight dark:text-white">GitAuto AI</span>
          </div>
          <div className="hidden md:flex items-center gap-8">
            <Link className="text-sm font-medium hover:text-primary transition-colors dark:text-white/70 dark:hover:text-white" href="#">Workflow</Link>
            <Link className="text-sm font-medium hover:text-primary transition-colors dark:text-white/70 dark:hover:text-white" href="#">Features</Link>
            <Link className="text-sm font-medium hover:text-primary transition-colors dark:text-white/70 dark:hover:text-white" href="#">Pricing</Link>
          </div>
          <div className="flex items-center gap-4">
            <SignInButton className="hidden sm:block text-sm font-semibold px-4 py-2 hover:opacity-80 transition-opacity dark:text-white">Log In</SignInButton>
      ...
      <main className="pt-24 overflow-x-hidden">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 relative">
              ...
              <div className="relative z-10 group">
                <div className="bg-white dark:bg-background-dark p-8 rounded-xl border border-gray-100 dark:border-white/5 shadow-xl shadow-gray-200/50 dark:shadow-none hover:-translate-y-2 transition-transform h-full">
                  ...
                  <h3 className="text-xl font-bold mb-3 dark:text-white">Upload</h3>
              ...
              <div className="relative z-10 group">
                <div className="bg-white dark:bg-background-dark p-8 rounded-xl border border-gray-100 dark:border-white/5 shadow-xl shadow-gray-200/50 dark:shadow-none hover:-translate-y-2 transition-transform h-full">
                  ...
                  <h3 className="text-xl font-bold mb-3 dark:text-white">AI Magic</h3>
              ...
              <div className="relative z-10 group">
                <div className="bg-white dark:bg-background-dark p-8 rounded-xl border border-gray-100 dark:border-white/5 shadow-xl shadow-gray-200/50 dark:shadow-none hover:-translate-y-2 transition-transform h-full">
                  ...
                  <h3 className="text-xl font-bold mb-3 dark:text-white">Sync</h3>
        ...
        {/* Core Features */}
        <section className="py-20 bg-background-light/50 dark:bg-background-dark/30 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row items-end justify-between mb-12 gap-6">
              <div className="max-w-xl">
                <h2 className="text-3xl md:text-4xl font-bold mb-4 dark:text-white">Built for teams that move fast</h2>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="p-8 bg-white dark:bg-background-dark rounded-3xl border border-gray-200 dark:border-white/5 shadow-sm">
                <span className="material-symbols-outlined text-4xl text-primary mb-6">psychology</span>
                <h4 className="text-xl font-bold mb-4 dark:text-white">AI Issue Recommendations</h4>
              ...
              <div className="p-8 bg-white dark:bg-background-dark rounded-3xl border border-gray-200 dark:border-white/5 shadow-sm">
                ...
                <h4 className="text-xl font-bold mb-4 dark:text-white">Feature Suggestions</h4>
              ...
              <div className="p-8 bg-white dark:bg-background-dark rounded-3xl border border-gray-200 dark:border-white/5 shadow-sm">
                ...
                <h4 className="text-xl font-bold mb-4 dark:text-white">Code Review Integration</h4>
      ...
      {/* Footer */}
      <footer className="bg-white dark:bg-background-dark border-t border-gray-200 dark:border-white/5 py-16 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-12">
          <div className="col-span-2">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-lg font-bold tracking-tight dark:text-white">GitAuto AI</span>
            </div>
          ...
          <div>
            <h6 className="font-bold text-sm mb-6 dark:text-white">Product</h6>
          ...
          <div>
            <h6 className="font-bold text-sm mb-6 dark:text-white">Resources</h6>
            <ul className="space-y-4 text-sm text-gray-500">
          ...
          <div>
            <h6 className="font-bold text-sm mb-6 dark:text-white">Company</h6>
            <ul className="space-y-4 text-sm text-gray-500">
        ...
        <div className="max-w-7xl mx-auto pt-16 mt-16 border-t border-gray-100 dark:border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
