...
export default async function WorkspacePage(props: { searchParams: Promise<{ repo?: string }> }) {
 ...
 <a className="text-sm font-medium text-slate-500 hover:text-primary transition-colors" href="#">Documents</a>
 ...
 <div className="mb-10">
 <h1 className="text-4xl font-bold tracking-tight mb-2">Issue Planner</h1>
 <p className="text-slate-500">Review recommendations and sync them to GitHub.</p>
 </div>
